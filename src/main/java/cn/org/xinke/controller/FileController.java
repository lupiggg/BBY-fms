...
public class FileController {
     ...
     * @return
     */
    private String getFile(String p, boolean download, HttpServletResponse response,HttpServletRequest request) {
        if (useNginx) {
            return useNginx(p);
        }
        if (fileDir == null) {
        ...
        outputFile(fileDir + p, download, response,request );
        return null;
    }
    ...
    public String file(@RequestParam("p") String p,
        ...
        return getFile( p, d == 1 ? true : false, response,request );
    }
     ...
     * @return
     */
    private String returnShareFileOrSm(String sid, boolean download, ModelMap modelMap, HttpServletResponse response,HttpServletRequest request) {
        String url = null;
        ...
        return getFile( url, download, response ,request);
    }
    ...
    public String shareFile(@RequestParam(value = "sid", required = true) String sid,
        ...
        return returnShareFileOrSm( sid, d == 1 ? true : false, modelMap, response ,request);
    }
    ...
    public String shareFileSm(@RequestParam(value = "sid", required = true) String sid,
                              HttpServletResponse response,
                              ModelMap modelMap,HttpServletRequest request) {
        return returnShareFileOrSm( sid, false, modelMap, response ,request);
    }
    ...
    @GetMapping("/file/sm")
    public String fileSm(@RequestParam("p") String p, HttpServletResponse response,HttpServletRequest request) {
        return getFile( p,false, response ,request);
    }
     ...
     * @param response
     */
    private void outputFile(String file, boolean download, HttpServletResponse response, HttpServletRequest request) {
        // 判断文件是否存,
        ...
        log.info("客户ip：" + request.getRemoteAddr());
